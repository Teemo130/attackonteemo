...
steps = 10
from finishscreen3 import Finishscreen3
...
def stage3screen(level,start=False):
    if start == True:
        ...
        while True:
            ...
            if len(mins) <= 9 and random.random() < 0.08:
