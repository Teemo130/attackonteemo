...
steps = 10
from finishscreen2 import Finishscreen2
...
def stage2screen(level,start=False):
    if start == True:
        ...
        moving = [pygame.image.load('teemo.png').convert_alpha(), pygame.image.load('teemomove1.png').convert_alpha(),
                  pygame.image.load('teemo.png').convert_alpha(), pygame.image.load('teemomove2.png').convert_alpha()]
        ...
        minion = Minion(minions, minions2, tim, level)
        ...
        while True:
            ...
            if len(mins) <= 7 and random.random() < 0.04:
